...
{
    public partial class Resete : System.Web.UI.Page
    {
        ...
        private void fillData()
        {
            ...
            this.RecetGV.DataSource = ent.Hasta_durumu.Where(q => q.Hasta_id == hastaid)
                .Join(ent.Randevus,
